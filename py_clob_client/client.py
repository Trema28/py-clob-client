...
class ClobClient:
    ...
    def get_ok(self):
        ...
        """
        return get(self._http_client, "{}/".format(self.host))
    ...
    def get_server_time(self):
        ...
        Does not need authentication
        """
        return get(self._http_client, "{}{}".format(self.host, TIME))
    ...
    def create_api_key(self, nonce: int = None) -> ApiCreds:
        ...
        creds_raw = post(self._http_client, endpoint, headers=headers)
        try:
            creds = ApiCreds(
    ...
    def derive_api_key(self, nonce: int = None) -> ApiCreds:
        ...
        creds_raw = get(self._http_client, endpoint, headers=headers)
        try:
            creds = ApiCreds(
                api_key=creds_raw["apiKey"],
                api_secret=creds_raw["secret"],
    ...
    def get_api_keys(self):
        ...
        return get(self._http_client, "{}{}".format(self.host, GET_API_KEYS), headers=headers)
    ...
    def get_closed_only_mode(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return get(self._http_client, "{}{}".format(self.host, CLOSED_ONLY), headers=headers)
    ...
    def delete_api_key(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return delete(self._http_client, "{}{}".format(self.host, DELETE_API_KEY), headers=headers)
    ...
    def create_readonly_api_key(self) -> ReadonlyApiKeyResponse:
        ...
        response = post(self._http_client, "{}{}".format(self.host, CREATE_READONLY_API_KEY), headers=headers)
        try:
    ...
    def get_readonly_api_keys(self) -> list[str]:
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return get(self._http_client, "{}{}".format(self.host, GET_READONLY_API_KEYS), headers=headers)
    ...
    def get_midpoint(self, token_id):
        ...
        """
        return get(self._http_client, "{}{}?token_id={}".format(self.host, MID_POINT, token_id))
    ...
    def get_midpoints(self, params: list[BookParams]):
        ...
        return post(self._http_client, "{}{}".format(self.host, MID_POINTS), data=body)

    def get_price(self, token_id, side):
        """
        Get the market price for the given market
        """
        return get(self._http_client, "{}{}?token_id={}&side={}".format(self.host, PRICE, token_id, side))
    ...
    def get_prices(self, params: list[BookParams]):
        ...
        return post(self._http_client, "{}{}".format(self.host, GET_PRICES), data=body)

    def get_spread(self, token_id):
        """
        Get the spread for the given market
        """
        return get(self._http_client, "{}{}?token_id={}".format(self.host, GET_SPREAD, token_id))
    ...
    def get_spreads(self, params: list[BookParams]):
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        return post(self._http_client, "{}{}".format(self.host, GET_SPREADS), data=body)

    def get_tick_size(self, token_id: str) -> TickSize:
        if token_id in self.__tick_sizes:
            return self.__tick_sizes[token_id]

        result = get(self._http_client, "{}{}?token_id={}".format(self.host, GET_TICK_SIZE, token_id))
    ...
    def get_neg_risk(self, token_id: str) -> bool:
        ...
        result = get(self._http_client, "{}{}?token_id={}".format(self.host, GET_NEG_RISK, token_id))
    ...
    def get_fee_rate_bps(self, token_id: str) -> int:
        ...
        result = get(self._http_client, "{}{}?token_id={}".format(self.host, GET_FEE_RATE, token_id))
    ...
    def cancel_orders(self, order_ids):
        ...
        return delete(
            self._http_client,
            "{}{}".format(self.host, CANCEL_ORDERS),
            headers=headers,
            data=serialized
        )
    ...
    def cancel_all(self):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return delete(self._http_client, "{}{}".format(self.host, CANCEL_ALL), headers=headers)
    ...
    def get_orders(self, params: OpenOrderParams = None, next_cursor="MA=="):
        ...
        while next_cursor != END_CURSOR:
            ...
            response = get(self._http_client, url, headers=headers)
    ...
    def get_order_book(self, token_id) -> OrderBookSummary:
        ...
        """
        raw_obs = get(self._http_client, "{}{}?token_id={}".format(self.host, GET_ORDER_BOOK, token_id))
    ...
    def get_order_books(self, params: list[BookParams]) -> list[OrderBookSummary]:
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        raw_obs = post(self._http_client, "{}{}".format(self.host, GET_ORDER_BOOKS), data=body)
    ...
    def get_order(self, order_id):
        ...
        headers = create_level_2_headers(self.signer, self.creds, request_args)
        return get(self._http_client, "{}{}".format(self.host, endpoint), headers=headers)
    ...
    def get_last_trade_price(self, token_id):
        ...
        """
        return get(self._http_client, "{}{}?token_id={}".format(self.host, GET_LAST_TRADE_PRICE, token_id))
    ...
    def get_last_trades_prices(self, params: list[BookParams]):
        ...
        """
        body = [{"token_id": param.token_id} for param in params]
        return post(self._http_client, "{}{}".format(self.host, GET_LAST_TRADES_PRICES), data=body)
    ...
    def get_notifications(self):
        ...
        return get(self._http_client, url, headers=headers)
    ...
    def drop_notifications(self, params: DropNotificationParams = None):
        ...
        return delete(self._http_client, url, headers=headers)
    ...
    def get_market(self, condition_id):
        ...
        """
        return get(self._http_client, "{}{}{}".format(self.host, GET_MARKET, condition_id))

    def get_market_trades_events(self, condition_id):
        """
        Get the market's trades events by condition id
        """
        return get(self._http_client, "{}{}{}".format(self.host, GET_MARKET_TRADES_EVENTS, condition_id))
